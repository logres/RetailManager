...
public class Info_12_Controller  implements Initializable {
    ...
    @FXML
    public JFXTextField text0, text1, text2, text3, text4;
    ...
    void butHandler(ActionEvent event) {    //显示订单信息
        ...
        List<Invoice> list = Starter.is.findInvoiceByUserId(ID);
